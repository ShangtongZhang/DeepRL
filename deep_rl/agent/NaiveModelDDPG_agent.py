...
class NaiveModelDDPGAgent(BaseAgent):
    ...
    def episode(self, deterministic=False):
        ...
        while True:
            ...
            if not deterministic and self.replay.size() >= config.min_memory_size:
                ...
                q_next = self.target_network.predict(next_states, depth=1, to_numpy=False)
                ...
                q = self.network.compute_q(phi, self.network.tensor(actions),
                ...
                q_values = [self.network.compute_q(phi.detach(), dead_action, depth=1)
